...
- 주요 내용  
  ...
  `Rhyme Optimization`: 한국어 음운규칙 기반의 운율 최적화 과정을 통해 모델로부터 얻은 힙합 가사의 운율을 극대화합니다.   
    - 운율 최적화 규칙은 [여기](https://github.com/iloveslowfood/Text2Hip/tree/master/RhymeEnhancement)를 참고해주세요.
